      ...
      <div className="container mx-auto max-w-6xl">
        <div className="text-center mb-20">
          <motion.h2 
            ...
            className="text-3xl md:text-5xl font-bold leading-tight mb-6 text-navy"
          >
        ...
        <div className="grid md:grid-cols-2 gap-8">
          {channels.map((channel, index) => (
            <motion.div
              ...
              className="bg-white p-8 md:p-10 rounded-3xl shadow-sm border border-charcoal/5 hover:shadow-md transition-shadow relative overflow-hidden group"
            >
              <div className="flex items-start gap-6">
                ...
                <div>
                  <div className="flex items-center gap-3 mb-2">
                    <span className="text-sm font-black text-charcoal/20">{channel.id}</span>
