          ...
          {projects.map((project, index) => (
            ...
            >
              <div className="relative aspect-[16/10] bg-oatmeal rounded-3xl overflow-hidden mb-6 shadow-sm group-hover:shadow-2xl transition-all duration-500">
                ...
                {/* Overlay on hover */}
                <div className="absolute inset-0 bg-navy/80 opacity-0 group-hover:opacity-100 transition-opacity duration-300 flex flex-col items-center justify-center text-white p-6 text-center">
              ...
              <div className="px-2">
                ...
                <p className="text-charcoal/60">{project.description}</p>
              </div>
            </motion.div>
          ))}
        </div>
